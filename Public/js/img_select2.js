...
$('.img-comit').click(function(){
        ...
        image();
        $('#imgSelect').show();
        $('#image0').html('<input type="hidden" name="imageURL[]" value="'+$(".imgurl input[type='checkbox']:checked:eq(0)").val()+'"><img src="'+$(".imgurl input[type='checkbox']:checked:eq(0)").val()+'" height="100">');
    });
    ...
    function image(){
        $('#image0').html('<input class="form-control radius" type="file" name="image[]">');
        $('#imgSelect').hide();
    }
