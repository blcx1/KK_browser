			...
			<div id="content-in">
				<div id="con-in">
					<div id="refresh">
						...
						<div id="img" onclick="location.href='<?php echo ($list['top'][0]['link_address']); ?>'">
							<img src="<?php echo ($list['top'][0]['icon_image'][0]); ?>">
						</div>

						<div id="t-title">
							<?php echo ($list['top'][0]['tit_name']); ?>
						</div>
					</div>
					<hr/>
					<ul class="list">
						<?php if(is_array($list['ordinary'])): $i = 0; $__LIST__ = $list['ordinary'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
								<a href="<?php echo ($vo["link_address"]); ?>">
									<div class="list-title">
										<?php if(is_array($vo["icon_image"])): $i = 0; $__LIST__ = $vo["icon_image"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mo): $mod = ($i % 2 );++$i;?><img src="<?php echo ($mo); ?>"><?php endforeach; endif; else: echo "" ;endif; ?>
