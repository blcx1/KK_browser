...
abstract class DefaultModel extends \Think\Model{
	...
	abstract public function info_add_process();//添加处理
	
	abstract public function info_update_process($id,$check_exists = false);//更新处理
	 ...
	 * @param unknown $where
	 */
	public function info_delete_process($where){
		
		$update_array['is_delete'] = 1;		
		return $this->info_update($where,$update_array);
	}
